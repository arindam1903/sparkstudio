...
export default function Search({query}) {
  ...
  return (
    <div id="search-result">
        ...
        {show.map((el) => (<div id="search-item">
          <div id="search-pic"> <img className='search-img' src={el.links[0].href}/></div>
          <div id='search-description'>  <div>{el.data[0].title}</div><div>{el.data[0].date_created}</div></div>
          </div>     ))}
